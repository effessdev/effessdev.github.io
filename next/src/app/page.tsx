      ...
      <div className="gradient">
        <header>
          <div className="header-inner">
            <h1>Hi, I am EffessDev</h1>
            <p className="lead">
              I build apps, games, and websites, and program MCUs and IoT
              devices.
            </p>
            ...
            <div className="social-links header-social">
              ...
              <a href="https://effessdev.itch.io/" className="btn">
                <i className="fab fa-itch-io"></i> itch.io
              </a>
              <a href="https://www.linkedin.com/in/effessdev/" className="btn">
      ...
      <main>
        <section>
          ...
          <div className="grid">
            <div className="card">
              <h3>MmOrganized</h3>
              <p>
                An AI-powered, multi-tenant, full-stack Next.js application with
                secure authentication (Google &amp; GitHub OAuth), payment
                gateway integration (Razorpay), and real-time notifications
                (using Pusher). Motion (Framer Motion), Shadcn UI, Drizzle ORM,
                Better Auth, and Lucide React were used to speed up development.
                New users get limited free credits to try it out!
              </p>
              <div className="card-links">
                <a href="https://mmorganized.vercel.app" className="btn">
                  Visit Website
                </a>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <p>
                ...
                button below to play without installing or download the game for
                free.
              </p>
              <div className="card-links">
                <a
            ...
            <div className="card">
              ...
              <p>
                ...
                including/excluding files using glob patterns, default patterns
                though reptclip-config.toml, easy install using pip, and custom
                presets.
              </p>
              <div className="card-links">
                <a href="https://github.com/effessdev/reptclip" className="btn">
                  View Repo
                </a>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="card">
            ...
            <p style={{ paddingLeft: "1rem" }}>Updated on: Aug 26, 2026</p>
          </div>
        </section>

        <section>
          <h2>Early Work &amp; Experiments</h2>
          <div className="grid">
            <div className="card">
              <h3>File Encrypter</h3>
              <p>
                A small Python GUI app made with Tkinter to encrypt and decrypt
                individual files.
              </p>
              <div className="card-links">
                <a
                  href="https://github.com/effessdev/file-encrypter"
                  className="btn"
                >
                  View Repo
                </a>
            ...
            <div className="card">
              ...
              <div className="card-links">
                <a href="https://effessdev.itch.io/apple-jump" className="btn">
                  Download on itch.io
                </a>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-links">
                <a
                  href="https://github.com/effessdev/recall-words"
                  className="btn"
                >
                  View Repo
                </a>
            ...
            <div className="card">
              <h3>Trigonometric Visualizer</h3>
              <p>
              ...
              <div className="card-links">
                <a
                  href="https://github.com/effessdev/trigonometric-visualizer"
                  className="btn"
                >
                  View Repo
                </a>
