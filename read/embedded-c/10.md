...
We previously covered bare-metal ISRs. With an RTOS, ISRs interact with the kernel:
...
The RTOS heap is separate from the application heap. Tasks, queues, and semaphores are allocated from the RTOS heap at runtime. Application data should still use static allocation or memory pools.
